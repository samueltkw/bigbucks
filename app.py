...
def dashboard(): 
    ...
    surveillance_logs = [ 
        {'ip': '192.168.0.12', 'activity': 'Port scan detected', 'timestamp': 
datetime.datetime.now()}, 
        {'ip': '10.0.0.8', 'activity': 'Login attempt failed', 'timestamp': 
datetime.datetime.now()}, 
        {'ip': '172.16.5.21', 'activity': 'Unusual traffic spike', 'timestamp': 
datetime.datetime.now()}, 
    ] 
